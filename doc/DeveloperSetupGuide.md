...
The following packages are required to build Omaha:
  ...
  * Google Software Construction Toolkit
    * Get the SCT source from [Google Code](http://code.google.com/p/swtoolkit/), either via direct download or via SVN checkout. Alternatively, a copy can be found on [GitHub](https://github.com/gabegundy/swtoolkit).
