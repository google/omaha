...
The following packages are required to build Omaha:
  ...
  * Third-party dependencies:
    ...
    * libzip 1.3.0. Source code [here](https://libzip.org/download/libzip-1.3.0.tar.gz). Unzip the contents of the directory libzip-1.3.0.tar.gz\libzip-1.3.0.tar\libzip-1.3.0\ into the directory googleclient\third_party\libzip.
    * zlib 1.2.11. Source code [here](https://zlib.net/zlib-1.2.11.tar.gz). Unzip the contents of the \zlib-1.2.11\ directory in zlib-1.2.11.tar into the directory googleclient\third_party\zlib\v1_2_11.       
