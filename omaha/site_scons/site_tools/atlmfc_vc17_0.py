...
def generate(env):
  ...
  if not env.get('ATLMFC_VC17_0_DIR'):
    env['ATLMFC_VC17_0_DIR'] = _FindLocalInstall()

  env.AppendENVPath('INCLUDE', env.Dir('$ATLMFC_VC17_0_DIR/include').abspath)
  env.AppendENVPath('LIB', env.Dir('$ATLMFC_VC17_0_DIR/lib/x86').abspath)
