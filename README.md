...
**This is __not__ an official Google product.**
...
We know that keeping software updated is both important and hard, and so by open-sourcing this project, our hope is that perhaps we can help others solve this problem. So, if you'd like to get involved, or even use Omaha to support your own software projects, then just follow the instructions in the [Developer Setup Guide](doc/DeveloperSetupGuide.md), and you'll be good to go!
